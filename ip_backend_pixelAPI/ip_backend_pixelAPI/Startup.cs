...
namespace ip_backend_pixelAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<PixelContext>(options => options.UseSqlServer(Configuration.GetConnectionString("GameConnectionString")));
            services.AddScoped<IVerification, Verification>();
            services.AddScoped<IUserData, SQLUserData>();
            services.AddScoped<ILogin, SQLLogin>();
